...
export function AjansCalendly() {
    useEffect(() => {
        ...
        Cal("init", "ajans", { origin: "https://app.cal.com" });

        Cal.ns.ajans("inline", {
            elementOrSelector: "#my-cal-inline-ajans",
            config: { "layout": "month_view", "useSlotsViewOnSmallScreen": "true" },
            calLink: "serkan-kupeli/tanisma-toplantisi",
        });

        Cal.ns.ajans("ui", { "theme": "dark", "hideEventTypeDetails": false, "layout": "month_view" });
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
                            Ajansınıza gelen taleplerdeki darboğazı birlikte netleştirelim. Size uygun zamanı seçin.
                        </p>
                    </motion.div>
