...
export function AjansHowItWorks() {
    const steps = [
        {
            number: "1",
            title: "Karşıla",
            desc: "Ajansınıza gelen tüm talepleri 7/24 otomatik olarak anında yanıtlar."
        },
        {
            number: "2",
            title: "Nitelendir",
            desc: "Hizmet ihtiyacını, bütçeyi ve zamanlamayı görüşme öncesinde otomatik toplar."
        },
        {
            number: "3",
            title: "Ölç",
            desc: "Tüm talepler ve dönüşüm verileri tek panelde canlı olarak görünür."
        }
    ];
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="max-w-3xl mx-auto text-center mb-20 md:mb-28">
                    ...
                    <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                        Karmaşık kurulum yok. 3 adımda ajansınıza gelen tüm talepler otomatik karşılanır, nitelendirilir ve panele düşer.
                    </p>
                </div>
