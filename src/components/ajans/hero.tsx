            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        >
                            Ajansınız İçin de, <span className="text-blue-400">Müşterileriniz İçin de</span> Otomatik Müşteri Karşılama
                        </motion.h1>
                        ...
                        >
                            Ajansınıza gelen yeni müşteri taleplerini anında karşılayın ve nitelendirin. Aynı sistemi kendi müşterilerinize de sunarak yeni bir hizmet kolu açın.
                        </motion.p>
                        ...
                        >
                            {[
                                "Ajansınıza gelen talepler 7/24 otomatik karşılanır",
                                "Hizmet ihtiyacı ve bütçe görüşme öncesinde toplanır",
                                "Müşterilerinize chatbot hizmeti sunarak gelir artırın"
                            ].map((item, index) => (
                        ...
                        >
                            <div className="flex flex-col items-center md:items-start gap-2 max-w-[320px] mx-auto md:mx-0 w-full">
                                <button
                                    ...
                                    className="group relative inline-flex h-14 overflow-hidden rounded-xl p-[1px] focus:outline-none w-full"
                                >
                                ...
                                <span className="text-sm text-gray-500 font-medium mt-4 w-full flex items-center justify-center md:justify-start gap-2">
                    ...
                    >
                        ...
                        <div className="relative rounded-2xl bg-slate-800/80 border border-slate-700 shadow-2xl p-6 backdrop-blur-xl overflow-hidden min-h-[400px] flex flex-col text-left">
                            <div className="flex items-center gap-3 border-b border-slate-700/50 pb-4 mb-4">
                                ...
                                <div className="text-xs text-slate-400 font-medium ml-2">FlowAsistan Panel — Yeni Talepler</div>
                            </div>

                            <div className="flex flex-col gap-4 flex-1">
                                <div className="self-start bg-slate-700/50 p-3.5 rounded-2xl rounded-tl-sm max-w-[85%] border border-slate-600/30">
                                    <p className="text-sm text-slate-200">Merhaba, firmamız için sosyal medya yönetimi ve Google Ads istiyoruz. Aylık bütçemiz 10-15k TL arası. Ne zaman başlayabiliriz?</p>
                                    <span className="text-[10px] text-slate-400 mt-1 block">Potansiyel Müşteri • 21:42</span>
                                </div>
                                ...
                                >
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <span className="text-xs text-blue-400 font-medium">Ajans Asistanı</span>
                                    </div>
                                    <p className="text-sm text-slate-200">Merhaba! Kaç kişilik bir ekip için çalışıyorsunuz ve hangi sektördesiniz? Böylece size en uygun yaklaşımı hızlıca aktarabilirim.</p>
                                    <span className="text-[10px] text-slate-400 mt-1 block">Otomatik • 21:42</span>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col text-sm">
                                        <span className="text-blue-400 font-medium">Lead Nitelendirildi</span>
                                        <span className="text-slate-300 text-xs mt-0.5">Bütçe: 10–15k TL · Hizmet: SMA + Google Ads</span>
                                    </div>
                                </motion.div>
                            </div>
                        </div>
